<?php /* Smarty version Smarty-3.1.19, created on 2016-11-17 11:27:42
         compiled from "/home/testing.4tiempos.cl/public_html/themes/theme1003/address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1039560129582dbe5e6eea98-12614228%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ee4e020d6f81abd7c34b222d6d356380e7a894a' => 
    array (
      0 => '/home/testing.4tiempos.cl/public_html/themes/theme1003/address.tpl',
      1 => 1477653247,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1039560129582dbe5e6eea98-12614228',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_582dbe5ea7b937_34492063',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_582dbe5ea7b937_34492063')) {function content_582dbe5ea7b937_34492063($_smarty_tpl) {?><?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?><?php echo smartyTranslate(array('s'=>'Your addresses'),$_smarty_tpl);?>
...
<?php }?><?php }?>" />
			...
			<?php }?>
			<!-- <?php if ($_smarty_tpl->tpl_vars['field_name']->value=='mi_campo') {?>
			 <div id="vat_area">
			  <div id="mi_campo">
			   <div class="form-group">
			    <label for="mi_campo"><?php echo smartyTranslate(array('s'=>'Mi_campo'),$_smarty_tpl);?>
</label>
			    <input type="text" class="form-control validate" data-validate="<?php echo $_smarty_tpl->tpl_vars['address_validation']->value[$_smarty_tpl->tpl_vars['field_name']->value]['validate'];?>
" id="mi_campo" name="mi_campo" value="<?php if (isset($_POST['mi_campo'])) {?><?php echo $_POST['mi_campo'];?>
<?php } else { ?><?php if (isset($_smarty_tpl->tpl_vars['address']->value->mi_campo)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['address']->value->mi_campo, ENT_QUOTES, 'UTF-8', true);?>
<?php }?><?php }?>" />
			   </div>
			  </div>
			 </div>
...
<?php }?><?php }?>" />
			...
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['field_name']->value=='comuna') {?>
			 	<div class="required form-group">
					<label for="id_comunas"><?php echo smartyTranslate(array('s'=>'Comuna'),$_smarty_tpl);?>
<sup>*</sup></label>
					<select id="id_comunas" class="form-control" name="comuna"><?php echo $_smarty_tpl->tpl_vars['comunas_list']->value;?>
</select>
				</div>
			<?php }?>
