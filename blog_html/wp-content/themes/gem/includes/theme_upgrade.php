...
<p class="wrap-header">   
   <a class="ask-question" href="http://www.webulousthemes.com/free-support-request/" target="_blank">
       <i class="fa fa-question-circle"></i> $gem_ask_question</a>
    <a class="view-doc" href="http://www.webulousthemes.com/gem-free/" target="_blank">
        <i class="fa fa-server"></i>$gem_documentation</a>
    <a class="upgrade" href="http://www.webulousthemes.com/theme/gem-pro" target="_blank">
        <i class="fa fa-upload"></i> $gem_upgrade_to_pro</a>
    <a class="view-demo" href="http://gem.webulous.in/" target="_blank">
        <i class="fa fa-eye"></i> $gem_view_demo</a> 
...
function gem_theme_page() {
	add_theme_page( 
		__( 'Upgrade To Gem Pro', 'gem' ),
		__( 'Theme Upgrade', 'gem' ),
		'edit_theme_options',
		'gem_upgrade',
		'gem_display_upgrade'
	);
