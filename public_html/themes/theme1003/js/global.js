...
{	
	btnHeight = $('#index .product-container').find('.button-container').outerHeight();
	$('#index .product-container .wrap-button-container').css({height:btnHeight})
...
$(document).ready(function(){
    if ($('#block_top_menu').length > 0) {
        ...
        if (stickMenu && docWidth > 780) {
            $('body').find('#block_top_menu_indent').wrapInner('<div class="stickUpTop"><div class="stickUpHolder">');
