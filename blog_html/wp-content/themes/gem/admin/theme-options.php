...
if( $typography_setting ) :
	...
	Gem_Kirki::add_field( 'gem', array(   
		...
		'label'    => __( 'Select Heading level', 'gem' ),
		'section'  => 'heading_section',
		'type'     => 'radio-buttonset',   
		'choices' => array(
			'h1'  => esc_attr__( 'H1', 'gem' ), 
			'h2' => esc_attr__( 'H2', 'gem' ),
			'h3'  => esc_attr__( 'H3', 'gem' ), 
			'h4' => esc_attr__( 'H4', 'gem' ),
			'h5'  => esc_attr__( 'H5', 'gem' ), 
			'h6' => esc_attr__( 'H6', 'gem' ),
		),
		'default'  => 'h1',
	) );
...
Gem_Kirki::add_section( 'header_image', array(
	'title'          => __( 'Header Background Image','gem' ),
