...
class AdminAddressesController extends AdminController
{
    ...
    public function __construct()
    {
        ...
        foreach ($comunas as $comuna) {
            $this->comunas_array[$comuna['id_comunas']] = $comuna['nombre'];
        }
        ...
        $this->fields_list = array(
            ...
            'comuna' => array('title' => $this->l('Comuna'), 'type' => 'select', 'list' => $this->comunas_array, 'filter_key' => 'a!comuna'),
        ...
        $this->_select = 'cl.`name` as country, com.nombre as comuna';
        $this->_join = '
            LEFT JOIN `'._DB_PREFIX_.'country_lang` cl ON (cl.`id_country` = a.`id_country` AND cl.`id_lang` = '.(int)$this->context->language->id.')
            LEFT JOIN `'._DB_PREFIX_.'comunas` com ON (com.`id_comunas` = a.`comuna`)
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'required' => true,
                    'options' => array(
                        'query' => $this->getComunas(),
                        'id' => 'id_comunas',
                        'name' => 'nombre'
                    ),
                    'hint' => Configuration::get('PS_ONE_PHONE_AT_LEAST') ? sprintf($this->l('Debes indicar la comuna del domicilio.')) : ''
                ),  
                array(
                    'type' => 'text',
